    ...
    return (
      ...
      <View style={{flex: 1, flexDirection: 'column'}}>
        ...
        <View style={styles.navBar}>
          <TouchableScale onPress={() => {this.props.navigation.navigate('LogInScreen')}} style={styles.hamburgerBar}>
            <Image source={require('../Image/backButton.png')} style={styles.hamburgerBar}/>
          </TouchableScale>
